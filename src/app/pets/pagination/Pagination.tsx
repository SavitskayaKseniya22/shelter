...
function Pagination() {
  ...
  useEffect(() => {
    if (animals && widthRange !== null && pageNumber > animals.getlastPageNumber(widthRange)) {
      ...
      {!!animals.getLength() && widthRange !== null && (
        <>
          ...
          <div className={styles.controls}>
            ...
            <Button colorType={ButtonColorType.COLORED} contentType={ButtonContentType.SYMBOL} onClick={() => {}}>
              {pageNumber}
            </Button>
