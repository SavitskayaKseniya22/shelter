...
function Header() {
  ...
  useEffect(() => {
    const handleClick = (event: MouseEvent) => {
      ...
      if (isOpen && (target.classList.contains(`${styles.navigation}`) || target.tagName === "A")) {
        setIsOpen(false);
  ...
  return (
    <header className={`${styles.header} ${pathname !== "/" ? styles.regular : styles.primary}`}>
      <div className={`${styles.container} container`}>
        ...
        <label htmlFor={styles["burger-icon"]} className={styles.navigation__burger} />
